...
# from cnn.small import layers
# from cnn.medium import layers
# from cnn.large import layers
from cnn.xl import layers
# from cnn.xxl import layers
# from small import layers
from dljungle.kerasutil import set_gpu_memory_target
